...
def test_parse_debt_penny_and_avg_rates_and_auctions():
    ...
    a = fetch.parse_avg_rates(
        [
            {
                "record_date": "2026-01-31",
                "security_type_desc": "Marketable",
                "security_desc": "Treasury Notes",
                "avg_interest_rate_amt": "2.75",
            }
        ]
    )[0]
    assert a["avg_interest_rate"] == 2.75 and a["security_desc"] == "Treasury Notes"

    ua = fetch.parse_upcoming_auctions(
        [
            {
                "cusip": "",
                "security_type": "Note",
                "security_term": "10-Year",
                "announcemt_date": "2026-01-05",
                "auction_date": "2026-01-12",
    ...
    ar = fetch.parse_auction_results(
        [
            {
                "cusip": "912828XX",
                "auction_date": "2026-01-12",
                ...
                "security_term": "10-Year",
                "high_yield_rate": "4.1",
                "bid_to_cover_ratio": "2.6",
                "offering_amt": "39000000000",
                "total_accepted_amt": "39000000000",
            }
        ]
    )[0]
...
def test_parse_yield_curve_rejects_doctype_entity_bomb():
    ...
    bomb = '<?xml version="1.0"?><!DOCTYPE lolz [<!ENTITY a "AAAA">]><feed><entry></entry></feed>'
