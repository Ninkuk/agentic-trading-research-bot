// shadcn Sheet on the Radix Dialog primitive (the same package dialog.tsx
// uses). Enter/exit animation classes are dropped like dialog.tsx does —
// tw-animate-css isn't installed, so they'd be dead class names.
