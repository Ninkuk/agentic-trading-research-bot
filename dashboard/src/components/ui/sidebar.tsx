// shadcn Sidebar (Radix flavor), ported by hand like the other primitives
// here. Departures from the registry copy: relative imports; no
// SidebarInput/SidebarMenuSkeleton (unused); open-state persistence is the
// caller's (AppShell keeps it in usePrefs, the app's one prefs store) —
// the registry's document.cookie write is gone.
