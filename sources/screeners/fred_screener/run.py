...
def run(db_path, only=None, exclude=None, add=None, start=None, keep_days=None,
        ...
        fetch_obs=fetch.fetch_observations, now_iso=None, vintages=False,
...
def main(argv=None):
    ...
    p.add_argument("--vintages", action="store_true", default=False,
    ...
    _, sc, oc = run(a.db, only=only, exclude=exclude, add=a.add, start=a.start,
                    keep_days=a.keep_days, vintages=a.vintages)
