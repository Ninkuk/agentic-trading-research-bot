...
_BULK_BASE = "https://www.sec.gov/files/dera/data/financial-statement-data-sets"
...
def fetch_frame(tag: str, unit: str, period: str, taxonomy: str = "us-gaap", get=_http_get) -> list:
                ...
                out.append(
                    {
                        ...
                        "tag": row["tag"],
                        "uom": row.get("uom"),
                        "period_end": _iso(row.get("ddate")),
                        "fiscal_year": _int(sub.get("fy")),
                        "fiscal_period": sub.get("fp"),
                        "value": _num(row.get("value")),
                        "form": sub.get("form"),
                        "filed": _iso(sub.get("filed")),
                        "accession": row["adsh"],
                        "name": sub.get("name"),
                        "sic": sub.get("sic"),
                    }
