...
finds notable, a page per ticker (its screen row, the newest thesis rendered
inline, and your own fills), and a running record of how its past opinions
actually worked out. Any term you don't recognize is probably in the
